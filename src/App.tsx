  ...
  return (
    <div className="h-full">
          ...
          <div className="navbar mb-2 shadow-lg bg-base-100 rounded-box">
            ...
            <div className="flex-none hidden px-2 mx-2 lg:flex">
              <div className="flex items-stretch">
                <a onClick={() => setPage('apps')} className={page === 'apps' ? "btn-active btn btn-ghost btn-sm rounded-btn" : "btn btn-ghost btn-sm rounded-btn"}>
                ...
                <div className="indicator">
                  ...
                  <a onClick={() => setPage('experiments')} className={page === 'experiments' ? "btn-active btn btn-ghost btn-sm rounded-btn" : "btn btn-ghost btn-sm rounded-btn"}>
            ...
            <div className="flex-none">
              <div className="dropdown dropdown-end">
                ...
                <ul className="shadow menu dropdown-content bg-base-100 rounded-box w-52">
                  ...
                  <li className="px-4 py-0 hover:bg-neutral">
                    <form action="#">
                      <div className="form-control">
                        <label className="cursor-pointer label">
                      ...
                      case 'string':
                        return (
                          <div className="form-control">
                            ...
                            <input type="text" name={field} className="input input-bordered input-primary" placeholder="" required={combined[field].required} />
                          </div>
                        )
                      case 'integer':
                      case 'float':
                        return (
                          <div className="form-control">
                            ...
                            <input type="number" name={field} className="input input-bordered input-primary" placeholder="" required={combined[field].required} />
                          </div>
                        )
                      case 'select':
                        return (
                      ...
                      case 'attachment':
                        return (
                          <label className="block lg:-mt-2 lg:-mb-2">
                            <span>{combined[field]?.label}</span>
                            <input type="file" name={field} multiple={true} className="mt-1 block w-full" required={combined[field].required} />
                          </label>
                        )
                      default:
                ...
                <tbody>
                  {experiments.map((exp, idx) => (
                    <tr>
                      ...
                      <td>{Array.from(exp['outputs']).map((x) => (<a className="link link-secondary" href={apiUrl + "/experiments/" + exp['id'] + "/file?" + new URLSearchParams({
                        'token': token,
                        'path': x as string
                      }).toString()} target="_blank" rel="noreferrer">{x as string}</a>))}</td>
                          ...
                          return (
                            <ul>
                              <li>{key}: <a href={apiUrl + "/experiments/" + exp['id'] + "/file?" + new URLSearchParams({
                                'token': token,
                                'path': exp['params'][key]
                              }).toString()} target="_blank" rel="noreferrer">{exp['params'][key]}</a></li>
                            </ul>)
                        } else {
                          return (
                            <ul>
                      ...
                      <td style={{ textTransform: 'capitalize' }}><div className="badge badge-primary">{exp['status']}</div></td>
                    </tr>
      ...
      <footer className="p-10 footer bg-primary text-primary-content footer-center">
        <div>
          <img src="https://ipp.cbica.upenn.edu/images/logo.png" alt="" className="inline-block" height="50" width="50" />
          <p className="font-bold">IPP
            <br />Image Processing Portal
          </p>
          <p>Copyright &copy; {new Date().getFullYear()} - <a href="#tos" className="link">Terms of service</a></p>
        </div>
